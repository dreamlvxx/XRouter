...
import com.dream.annotation_complier.base.bean.FieldEntity;
...
public class EntityHandler {
    ...
    private String handlerClass(TypeElement element) {
        ClassEntity classEntity = new ClassEntity(elementUtils, typeUtils, element);
        String className = classEntity.getClassQualifiedName();
    ...
    private void handlerMethod(ExecutableElement element) {
        ...
        String className = handlerClass((TypeElement) element.getEnclosingElement());
    ...
    private void handlerField(VariableElement element) {
        ...
        //add to map
        //get the class name
        String clasaName = handlerClass((TypeElement) element.getEnclosingElement());
        //set the field
