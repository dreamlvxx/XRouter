package com.dream.annotation_complier.base.bean;
...
public class ClassEntity {
    ...
    public void addMethodEntity(MethodEntity methodEntity) {
        ...
        List<? extends VariableElement> parameterElements = methodEntity.getParameterElements();
        StringJoiner paramSign = new StringJoiner(",");
        if (parameterElements != null) {
            for (VariableElement parameterElement : parameterElements) {
                paramSign.add(parameterElement.getSimpleName());
            }
        }

        String tag = methodName + paramSign;
    ...
    public String toString() {
        ...
        for (Map.Entry<String, MethodEntity> item : methods.entrySet()) {
            methodString.append("Method:" /*+ item.getKey()*/ +
                    "\n" + item.getValue().toString() + "\n");
        }
